...
SECRET_KEY: str = (
    "b821bcc3363eda4506ba5af73af81b5945069293a05e58a324ebfaa040d7a4f1"
...
def decode_access_token(token: Annotated[str, Depends(oauth2_scheme)]):
    credentials_exception = JSONException(
        status_code=401, error={"message": "Could not validate jwt"}
    )
    try:
...
def create_login_access_token(login: LoginCredentials) -> str:
    ...
    return _create_access_token(
        {"sub": login.username, "guest": False},
    )
